...
# ----------------------------
# Main Routine: Output in Desired JSON Format and Save to File
# ----------------------------
def main():
    ...
    # Create output dictionary in the desired format.
    output = {
    ...
    output_filename = input("Enter output file name (e.g., episode_output.json): ").strip()
    if not output_filename:
        output_filename = "episode_output.json"
